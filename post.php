...
<form method="post" action="main_dashboard.php">
  ...
  <div class="form-group">
    ...
    <option href="#">Technology in Education</option>
    <option href="#">Scholorship</option>
...
<textarea class="form-control" placeholder="Enter your content here" rows="10" id="comment" name="text"></textarea>
