...
$sql = "SELECT * FROM dashboard WHERE category='Examination Tips' Order By id DESC";
...
<head>
    ...
    <title>Eduforum/Career Ride</title>
...
<nav class="navbar navbar-expand-sm bg-light navbar-light  pl-5 pr-5">
  ...
  <div class="dropdown-menu p-3">
    ...
    <li class="nav-item">
      <a class="nav-link as active" href="#">Latest Update</a>
    </li>
    <li class="nav-item">
...
<div class="user">
      <img src="image/bead.jpg" height="50px"; width="50px">
